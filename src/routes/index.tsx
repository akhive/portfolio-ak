...
const skills = [
  { icon: Code2, title: "React & TypeScript", description: "Component-driven UIs with type-safe codebases." },
  { icon: Server, title: "Node.js & Backend", description: "Scalable APIs, serverless functions, and data modeling." },
  { icon: Database, title: "Databases", description: "PostgreSQL, Supabase, and modern ORM workflows." },
  { icon: Figma, title: "UI/UX Design", description: "User-centered interfaces from wireframes to polished designs." },
  { icon: Layout, title: "Responsive Layouts", description: "Fluid designs that work beautifully on every device." },
  { icon: Zap, title: "Performance", description: "Fast loads, optimized assets, and smooth interactions." },
];
...
const projects = [
  {
    ...
    description:
      "A real-time analytics platform for subscription businesses with interactive charts and reporting tools.",
  ...
  },
  {
    ...
    description:
      "A headless commerce experience focused on speed, accessibility, and conversion optimization.",
  ...
  },
  {
    ...
    description:
      "An AI-assisted writing and editing tool with collaborative workspaces and version history.",
    tags: ["OpenAI", "Node.js", "Supabase"],
    href: "#",
  },
];
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div className="space-y-8">
            ...
            <p className="max-w-xl text-lg leading-relaxed text-muted-foreground sm:text-xl">
              ...
              experiences. I turn complex problems into elegant, user-friendly products.
            </p>
    ...
    <section id="contact" className="relative border-t border-border/50 bg-card/30 py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid gap-16 lg:grid-cols-2 lg:gap-24">
              ...
              <div className="flex gap-4 pt-2">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="flex h-11 w-11 items-center justify-center rounded-full border border-border bg-card text-muted-foreground transition-all hover:border-primary/50 hover:bg-accent hover:text-foreground"
                  >
          ...
          <form
            action="mailto:hello@alexmorgan.dev"
            method="post"
            encType="text/plain"
